...
const Modal = ({setIsModalOpen, isModalOpen}) => {
    ...
    return(
        <div className={styles.wrapper} style={{width: location.includes("/logIn") ? "100%" : wrapperWidth, position: location.includes("/logIn") ? "absolute" : 'fixed'}}>
            ...
            <AnimatePresence>
                {isModalOpen && 
                    ...
                    variants={Opacity} initial="initial" animate="animate" exit="initial">
                        ...
                        {location.includes("/logIn") && <LogIn setIsModalOpen={setIsModalOpen}/>}
