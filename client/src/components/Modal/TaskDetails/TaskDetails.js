...
import { ScaleAndOpacity2, ScaleAndOpacity } from "../../../animations/animations";
...
const TaskDetails = ({setIsModalOpen}) => {
        ...
        const handleSubmit = async (e) => {
            ...
            if(confirmationStep){
                ...
                await getContent('/tasks', currentContent, filters)
            }else{
        ...
        <form className={styles.wrapper} onSubmit={handleSubmit}>
            ...
            <AnimatePresence>
                {confirmationStep && 
                    <motion.div className={styles.confirmationStep} variants={ScaleAndOpacity2} initial="initial" animate="animate" exit="initial" >
            ...
            <div className={styles.buttons}>
                {!confirmationStep && <a href={task?.link} target="_blank" ><Button style={{width: "100%"}} secondary text={"Sprawdź"}/></a>}
